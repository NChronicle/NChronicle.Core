...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;NChronicle.SMTP.SmtpChronicleLibrary<br />
...
**VB**<br />
``` VB
Public Class SmtpChronicleLibrary
	Implements IChronicleLibrary, IXmlSerializable
```

**F#**<br />
``` F#
type SmtpChronicleLibrary =  
    class
...
<br />
The SmtpChronicleLibrary type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_NChronicle_SMTP_SmtpChronicleLibrary__ctor.md">SmtpChronicleLibrary</a></td><td>
Create a new SmtpChronicleLibrary instance with the default configuration.</td></tr></table>&nbsp;
<a href="#smtpchroniclelibrary-class">Back to Top</a>
...
Configure this SmtpChronicleLibrary with the specified options.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="http://msdn2.microsoft.com/en-us/library/bsc2ak47" target="_blank">Equals</a></td><td>
...
#### Reference
<a href="N_NChronicle_SMTP.md">NChronicle.SMTP Namespace</a><br />
