# ConsoleChronicleLibraryConfiguration.WithWarningBackgroundColor Method 
 

Render all Warning level records with the specified *backgroundColor*. The default is <a href="http://msdn2.microsoft.com/en-us/library/s66hf68a" target="_blank">Black</a>.
...
**C#**<br />
``` C#
public void WithWarningBackgroundColor(
...
**VB**<br />
``` VB
Public Sub WithWarningBackgroundColor ( 
...
**F#**<br />
``` F#
member WithWarningBackgroundColor : 
