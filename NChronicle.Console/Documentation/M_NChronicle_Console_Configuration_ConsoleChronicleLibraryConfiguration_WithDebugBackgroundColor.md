# ConsoleChronicleLibraryConfiguration.WithDebugBackgroundColor Method 
 

Render all Debug level records with the specified *backgroundColor*. The default is <a href="http://msdn2.microsoft.com/en-us/library/s66hf68a" target="_blank">Black</a>.
...
**C#**<br />
``` C#
public void WithDebugBackgroundColor(
...
**VB**<br />
``` VB
Public Sub WithDebugBackgroundColor ( 
...
**F#**<br />
``` F#
member WithDebugBackgroundColor : 
