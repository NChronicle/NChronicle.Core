...
Container for <a href="T_NChronicle_File_FileChronicleLibrary.md">FileChronicleLibrary</a> configuration.
...
**VB**<br />
``` VB
Public Class FileChronicleLibraryConfiguration
	Implements IXmlSerializable
```

**F#**<br />
``` F#
type FileChronicleLibraryConfiguration =  
    class
...
<br />
The FileChronicleLibraryConfiguration type exposes the following members.
...
<a href="#filechroniclelibraryconfiguration-class">Back to Top</a>
