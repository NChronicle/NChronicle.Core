# Chronicle.Info Method (String, Exception, String[])
 

Record a <a href="T_NChronicle_Core_Model_ChronicleLevel.md">Info</a> level message and <a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">Exception</a> with the specified *tags*.
...
#### Implements
<a href="M_NChronicle_Core_Interfaces_IChronicle_Info_1.md">IChronicle.Info(String, Exception, String[])</a><br />
