# Chronicle.Success Method (Exception, String[])
 

Record a <a href="T_NChronicle_Core_Model_ChronicleLevel.md">Success</a> level <a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">Exception</a> with the specified *tags*.
...
#### Implements
<a href="M_NChronicle_Core_Interfaces_IChronicle_Success.md">IChronicle.Success(Exception, String[])</a><br />
